...
jQuery(document).ready(function(){
    jQuery(".member-photo").click(function(){
          var breif = jQuery(this).parent(".team-member");
             ...
             jQuery(".team-member").css({"width":"200px","height":"220px","background":"white"})
    ...
    jQuery(".close-intro").click(function(){
             ...
             jQuery(this).parents(".team-member").animate({ width: "200px" }, { duration: 0, queue: false }).animate({ height: "220px" }, 0);
